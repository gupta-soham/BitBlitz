      ...
      <div className="container flex items-center justify-between h-16 px-4 md:px-6">
        ...
        <Sheet>
          <SheetTrigger asChild>
            <Button variant="outline" size="icon" className="md:hidden bg-slate-700 border-slate-600 hover:bg-slate-600">
              <Menu className="h-6 w-6 text-slate-300" />
              <span className="sr-only">Toggle navigation menu</span>
            </Button>
          </SheetTrigger>

          <SheetContent side="left" className="bg-slate-800/80 backdrop-blur-lg border-r border-slate-700">
        ...
        {session?.user ? (
          ...
          <div className={cn("flex items-center gap-4 hidden md:flex")}>
            ...
            <Button size="sm" className="bg-cyan-600 hover:bg-cyan-500 text-slate-100">
